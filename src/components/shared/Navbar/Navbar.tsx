...
const NavItems = [
  ...
  { id: "2", name: "Categories", route: "" },
  { id: "3", name: "Products", route: "/laptops" },
...
const Navbar = () => {
  ...
  return (
    <div className=" bg-white backdrop-blur-md z-[999] text-black border-b-2">
      <Container>
        <header className=" mx-auto py-3 flex justify-between items-center z-50 ">
          ...
          <nav
            className={
              mobileMenuOpen
                ? " w-full lg:static absolute top-[50px] left-0 lg:bg-none bg-white transition-all lg:z-0 -z-50 lg:border-none border-b-2 border-black"
            ...
            <div className="hidden lg:block">
              <ul className="flex justify-end items-center gap-8 lg:flex-row flex-col lg:py-0 py-10">
                {NavItems.map((navItem) => (
                  <li
                    key={navItem.id}
                    className="lg:mb-0 mb-5 cursor-pointer  group relative text-black"
                  >
                    <Link
                      href={navItem.route}
