      ...
      <div className="border-2 rounded-md w-[280px] bg-white overflow-hidden">
        <div className="relative bg-[#ffffff] p-5 w-[280px] h-[360px] border-b-2 rounded-t-md flex justify-center items-center group overflow-hidden">
          <Image
            ...
            height={0}
            sizes="100vw"
            className="group-hover:scale-110 transition-all duration-500 w-[280px] h-[260px] "
          />
        ...
        <div className="p-2">
          ...
          <div className="flex justify-between items-center text-sm">
            <div>
              ...
              <del className="text-slate-600">230.00</del>{" "}
              <span>
                <span className="text-2xl font-bold">৳</span>230.00
              </span>
            </div>
